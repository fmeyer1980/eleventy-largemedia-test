...
module.exports = (url, alt = "Missing alt text") => {
  ...
  <source srcset="/assets/images/tiny/${url}" media="(min-width: 1200px)">
  <source srcset="/assets/images/tiny/${url}" media="(min-width: 740px)">
  <img src="/assets/images/tiny/${url}" alt="${alt}" /></picture>`;
};
